package com.example.goole_vision_ex;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        count_message = findViewById(R.id.count_text);
...
// for ActivityCompat#requestPermissions for more details.
    ...
    //update view
    public void updateMainView(Condition condition, int open_count, int close_count){
        int count = 0;
        switch (condition){
            case USER_EYES_OPEN:
                setBackgroundGreen();
        ...
        if((open_count + close_count) == 2){
            count ++;
            count_message.setText("count : "+count);
            open_count = 0;
            close_count = 0;
        }
    }
